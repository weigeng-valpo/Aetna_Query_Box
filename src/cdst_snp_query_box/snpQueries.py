...
def pull_ev_call_bq():
    import subprocess
    from google.cloud import bigquery
    query = snpQueryList.pull_ev_call_bq_sql
...
def pull_ev_call_current_year_bq():
    import subprocess
    from google.cloud import bigquery
    query = snpQueryList.pull_ev_call_current_year_bq_sql
...
def pull_ev_call_sop_bq():
    import subprocess
    from google.cloud import bigquery
    query = snpQueryList.pull_ev_call_sop_bq_sql
...
def pull_home_and_community_based_services_claim_line():
    import subprocess
    from google.cloud import bigquery
    query = snpQueryList.pull_home_and_community_based_services_claim_line_bq_sql
...
def pull_skilled_nursing_facility():
    import subprocess
    from google.cloud import bigquery
    query = snpQueryList.pull_skilled_nursing_facility_bq_sql
