...
import numpy as np
from cdst_snp_query_box import DsnpHelperFunction, dsnpStyle
from cdst_snp_query_box.dsnp_transform import callLogTransform
...
def mj_prepare_pull_call(pull_call_log_all_dsnp, condensed_dsnp_mbr):
    """
    pull_call_log_all_dsnp(pandas.DataFrame): use "pull_call_log_all_dsnp" file from snpQueries in cdst_snp_query_box
